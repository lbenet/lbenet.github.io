...
- \biblabel{2023BFR}{} \LB, L. Ferranti and N. Revol\\ A framework to test interval arithmetic libraries and their IEEE 1788-2015 compliance\\ \it{Concurrency Computat. Pract. Exper.} \bf{36} (2023), e7856. \doi{10.1002/cpe.7856} \arXiv{2307.06953} (*open access*)

- \biblabel{2023BBIS}{} \LB, F. Borgonovi, F.M. Izrailev, and L.F. Santos\\ Quantum-classical correspondence of strongly chaotic many-body spin models\\ \it{Phys. Rev. B} \bf{107} (2023), 155143. \doi{10.1103/PhysRevB.107.155143} \arXiv{2211.10451}
...
- \biblabel{2022PHB}{} J.A. Pérez-Hernández and \LB\\ Non-zero Yarkovsky acceleration for near-Earth asteroid (99942) Apophis\\ \it{Commun. Earth & Environment} \bf{3} (2022), Art. Num. 10. \doi{10.1038/s43247-021-00337-x} (*open access*)
...
- \biblabel{2017BJ}{} \LB and À. Jorba\\ A simple model for the location of Saturn's F ring\\ \it{Icarus} \bf{285} (2017), 224-236 (13 pages). \doi{10.1016/j.icarus.2016.12.006} \arXiv{1612.01451}
...
- \biblabel{2010BHS}{} \LB, S. Hernández-Quiroz and T.H. Seligman\\ Fidelity decay of the two-level bosonic embedded ensembles of Random Matrices\\ <!-- in "Symmetries in Nature. Symposium in Memoriam of Marcos Moshinsky", L. Benet, P.O. Hess, J.M. Torres, and K.B. Wolf (eds.).--> \it{AIP Conference Proceedings} \bf{1323} (2010), 6-15. \doi{10.1063/1.3537867} \arXiv{1011.0684}
...
- \biblabel{2007BBK}{} \LB, M. Bienert and S. Yu. Kun\\ Thermalized non-equilibrated matter and high temperature superconducting state in quantum many-body systems\\ \it{Radiat. Eff. Defects Solids} \bf{162} (2007), 605--612. \doi{10.1080/10420150701470894} \arXiv{0705.0509}.
...
- \biblabel{2003BW}{} \LB and H.A. Weidenmüller\\ Review of the $k$-Body Embedded Ensembles of Gaussian Random Matrices\\ \it{J. Phys. A: Math. Gen.} \bf{36} (2003), 3569--3593. \doi{10.1088/0305-4470/36/12/340} \arXiv{cond-mat/0207656}\\ <!-- [\bf{Selected as} IOP Physics Reviews: March 2003](http://www.iop.org/EJ/ejs_extra/-coll=rev) -->
...
- \biblabel{2003KBCGH}{} S.Yu. Kun, \LB, L.T. Chadderton, W. Greiner and F. Haas\\ Macroscopic quantum superpositions in highly excited strongly interacting many--body systems\\ \it{Phys. Rev. C} \bf{67} (2003), 011604R (4 pages). \doi{10.1103/PhysRevC.67.011604} \arXiv{quant-ph/0205036}\\ <!-- Selected in [\it{Virtual Journal of Nanoscale Science \& Technology} \bf{7}, Iss. 6, (2003), February 10](http://www.vjnano.org). -->
...
- \biblabel{2001ABRW}{} T. Asaga, \LB, T. Rupp and H.A. Weidenmüller\\Non--ergodic behaviour of the $k$-Body embedded Gaussian random ensembles for bosons\\ \it{Europhys. Lett.} \bf{56} (2001), 340--346. \doi{10.1209/epl/i2001-00525-0} \arXiv{cond-mat/0107363}
...
- \biblabel{2024ARCH-AINNCS}{} Diego Manzanas Lopez, Matthias Althoff, Luis Benet, Clemens Blab, Marcelo Forets, Yuhao Jia, Taylor T Johnson, Manuel Kranzl, Tobias Ladner, Lukas Linauer, Philipp Neubauer, Sophie Neubauer, Christian Schilling, Huan Zhang and Xiangru Zhong\\ ARCH-COMP24 Category Report: Category Report: Artificial Intelligence and Neural Network Control Systems (AINNCS) for Continuous and Hybrid Systems Plants\\ in "11th International Workshop on Applied Verification of Continuous and Hybrid   Systems (ARCH24)", Goran Frehse and Matthias Althoff (eds.), EPiC Series in Computing vol 103 (2024), pp 64-121. \doi{10.29007/mxld} \pdf{https://easychair.org/publications/paper/WsgX}

- \biblabel{2024ARCH-COMP}{} Luca Geretti, Julien Alexandre Dit Sandretto, Matthias Althoff, Luis Benet, Pieter Collins, Marcelo Forets, Stefan Mitsch, Christian Schilling, Joris Tillet and Mark Wetzlinger\\ ARCH-COMP24 Category Report: Continuous and Hybrid Systems with Nonlinear Dynamics\\ in "11th International Workshop on Applied Verification of Continuous and Hybrid Systems (ARCH24)", Goran Frehse and Matthias Althoff (eds.), EPiC Series in Computing vol 103 (2024), pp 39-63. \doi{10.29007/21ch} \pdf{https://easychair.org/publications/paper/QD5d}

- \biblabel{2024ProcIAU}{} Luis Benet and Jorge A. Pérez-Hernández\\ Transversal Yarkovsky acceleration for Apophis through jet transport\\ in "Complex Planetary Systems II: Latest Methods for an Interdisciplinary Approach", A. Lemaitre and A.-S. Libert (eds.), Proceedings IAU Symposium vol 18 (S382), (2022), pp. 59–65. \doi{10.1017/S174392132300399X} \pdf{https://www.cambridge.org/core/journals/proceedings-of-the-international-astronomical-union/article/transversal-yarkovsky-acceleration-for-apophis-through-jet-transport/C5833DC3D74A93FF34E2076F8EDA2E2E}

- \biblabel{2023ARCH-COMP}{} Luca Geretti, Julien Alexandre Dit Sandretto, Matthias Althoff, Luis Benet, Pieter Collins, Marcelo Forets, Elena Ivanova, Yangge Li, Sayan Mitra, Stefan Mitsch, Christian Schilling, Mark Wetzlinger and Daniel Zhuang\\ ARCH-COMP23 Category Report: Continuous and Hybrid Systems with Nonlinear Dynamics\\ in "10th International Workshop on Applied Verification of Continuous and Hybrid Systems (ARCH23)", Goran Frehse and Matthias Althoff (eds.), EPiC Series in Computing vol 96 (2023), pp 61--88. \doi{10.29007/93f2} \pdf{https://easychair.org/publications/paper/T7LG}
...
- \biblabel{2015BS}{} \LB and D.P. Sanders\\ Forward automatic differentiation and Taylor series<!--\fNote-->\\ in "Memorias de la XXIII Escuela de Verano en Física", José Recamier y Rocío Jáuregui (eds), (2015) pp 51-65. \pdf{http://www.fis.unam.mx/pdfs/MEMORIAS_XXIII_ESCUELA_VERANO_2015.pdf}
...
<!-- - \biblabel{KBMdPSASV2010}{} K. Kumar, \LB, C.H. Mena, I. de Pater, M.R. Showalter, B.A.C. Ambrosius, E.J.O. Schrama, P.N.A.M. Visser\\ Using a statistical accretion model to predict the existence of undetected moons around Uranus in the vicinity of Mab\\ in "AAS/Division of Dynamical Astronomy Meeting \#41", BAAS, Vol. 41, p. 933 (2010). \pdf{http://labs.adsabs.harvard.edu/adsabs/abs/2010DDA....41.0806K/} -->
...
<!-- - \biblabel{B2000}{} \LB\\ Planetary Rings with Shepherds: Generic Aspects\\ in Astronomische Gesellschaft Abstract Series, Vol. 17. Abstracts of Contributed Talks and Posters presented at the Annual Scientific Meeting of the Astronomische Gesellschaft at Bremen, September 18-23, 2000. -->
...
- \biblabel{2012B}{} \LB. Caos determinista, con lápiz y papel. Periódico "La Unión de Morelos", 31 de diciembre del 2012, pp. 36-37.
